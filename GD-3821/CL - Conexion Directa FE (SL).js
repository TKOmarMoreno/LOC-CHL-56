 ...
 */
 define(
    [
        "N/search", "N/record", "N/format", "N/xml", "N/file", "N/https", "N/runtime", "N/encode", "N/http", "N/config", "N/email", "L56/utilidades", 'N/translation'
    ],
    /* global define log */
    function (search, record, format, xml, file, https, runtime, encode, http, config, email, utilities, translation) {
        var URL = "";
        var USER = "";
        var PASSWORD = "";
        var ACTECO = "";
        ...
        function onRequest(context) {
            ...
            try {
                ...
                let mensajeError = translation.get({
        ...
        function send(context) {
            ...
            try {
                ...
                typeRecord = obj_type.recordtype;
                ...
                let estadoAprobacion = rec.getValue({ fieldId: 'approvalstatus' });

                if ((isEmpty(estadoAprobacion)) || (!isEmpty(estadoAprobacion) && (estadoAprobacion != 1 && estadoAprobacion != 3))) {
                    ...
                    */
                    if (IdAccountProv == idAccount) {
                        ...
                        result.success = false;
                        let mensajepart1 = translation.get({
                            collection: 'custcollection_l56_fe_translate',
                            key: 'SUITELET_E_02'
                        })();
                        let mensajepart2 = translation.get({
                            collection: 'custcollection_l56_fe_translate',
                            key: 'SUITELET_E_03'
                        })();
                        let mensajepart3 = translation.get({
                            collection: 'custcollection_l56_fe_translate',
                            key: 'SUITELET_E_04'
                        })();
                        let mensajepart4 = translation.get({
                            collection: 'custcollection_l56_fe_translate',
                            key: 'SUITELET_E_05'
                        })();
                        let mensajepart5 = translation.get({
                            collection: 'custcollection_l56_fe_translate',
                            key: 'SUITELET_E_06'
                        })();
                        ...
                        result.message =  mensajepart1 + "\t "+mensajepart2+" \t "+mensajepart3 + idAccount + mensajepart4 + IdAccountProv + "\t "+mensajepart5;
                        log.error("send()", "Estado: " + result.success + " - Error: " + result.message);
                    }
                } else {
                    result.success = false;
                    //result.message = 'La transacción se encuentra pendiente de aprobacion o rechazado.';
                    let messagepart = translation.get({
                        collection: 'custcollection_l56_fe_translate',
                        key: 'SUITELET_E_07'
                    })();
                ...
                result.message = messagepart + e.message;
                log.error("send()", "Estado: " + result.success + " - Error: " + result.message);
            }
            ...
            if (!isEmpty(estadoOperacion)) {
                ...
                if (!isEmpty(descripcionOperacionId)) {
                    ...
                    if (estadoOperacionId == "1") {
                        ...
                        let mensajeTrad = translation.get({
                            collection: 'custcollection_l56_fe_translate',
                            key: 'SUITELET_E_09'
                        })();
                        descripcionOperacionId = mensajeTrad;
                    } else {
                        exitoGenerate = false;
